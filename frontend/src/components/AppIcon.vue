...
<template>
  ...
  >
    ...
    <template v-else-if="name === 'document-text'">
      <path d="M9 12h6M9 16h6M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
    </template>
    ...
    <template v-else-if="name === 'database'">
      <path d="M4 7c0 1.657 3.582 3 8 3s8-1.343 8-3M4 7v5c0 1.657 3.582 3 8 3s8-1.343 8-3V7M4 7V5c0-1.657 3.582-3 8-3s8 1.343 8 3v2" />
    </template>
    ...
    <template v-else-if="name === 'cube'">
      <path d="M20 7l-8-4-8 4m16 0l-8 4m8-4v10l-8 4m0-10L4 7m8 4v10M4 7v10l8 4" />
      <path d="M12 3l6 3-6 3-6-3 6-3z" opacity="0.3" />
    </template>
