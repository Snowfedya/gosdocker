...
COMPONENTS = [
    ...
    },
    {
        ...
        "is_registry": False,  # РЕД ОС реестр не содержит ClickHouse (verified 2026-06-15: /v2/_catalog — 118 репозиториев, clickhouse отсутствует). Fallback на официальный образ в dh-mirror.
        "description": "Высокопроизводительная колоночная СУБД для аналитики. Официальный upstream-образ (РЕД ОС не публикует ClickHouse в своём registry)",
        "version": "24.3",
    ...
    },
    {
        ...
        "image_source": "dh-mirror.gitverse.ru",
        "registry_url": "dh-mirror.gitverse.ru/library/mariadb:10.6",
        "is_registry": False,  # РЕД ОС реестр не содержит MariaDB (verified 2026-06-15: /v2/_catalog — 118 репозиториев, mariadb отсутствует). Fallback на официальный образ в dh-mirror.
        "description": "Реляционная СУБД MariaDB. Официальный upstream-образ (РЕД ОС не публикует MariaDB в своём registry)",
        "version": "10.6",
